...
- [ ] T133 [US7] Restore the latest persisted V3 Batch and stop terminal polling while preserving retry switch-over in `apps/project-web/app/api/storyboard-versions/[versionId]/workflow-plans/route.ts` and `apps/project-web/components/storyboards/capability-v3-batch-review.tsx`
